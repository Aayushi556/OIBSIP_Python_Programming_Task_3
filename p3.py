...
frame=Frame(window,bg="#D3D3D3",width=250,height=250,bd=2,relief="solid",padx=20,pady=20)
...
checkbox_2=Checkbutton(frame,text="Includes Character",bg='#D3D3D3',
                       variable=y,
...
checkbox_3=Checkbutton(frame,text="Includes uppercase character",bg='#D3D3D3'
...
checkbox_4=Checkbutton(frame,text="Includes lowercase character",bg='#D3D3D3',
...
checkbox_5=Checkbutton(frame,text="Includes Special character",bg='#D3D3D3',
...
def result():
    ...
    try:
        label_2.config(height=5,bg='#D3D3D3',fg="black")
        button["text"]="Copy"
        button.grid_forget()
...
label_2=Label(frame_2,bg='#D3D3D3')
